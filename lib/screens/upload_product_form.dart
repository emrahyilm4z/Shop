    ...
    if (isValid) {
      ...
      try {
        if (_pickedImage == null) {
          _globalMethods.authErrorHandle('Resim seç', context);
        } else {
          setState(() {
            _isLoading = true;
          });
                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              items: const [
                                ...
                                DropdownMenuItem<String>(
                                  child: Text('Güzellik bakım'),
                                  value: 'Beauty',
                                ),
                                DropdownMenuItem<String>(
                                  child: Text('Ayakkabılar'),
                                  value: 'Shoes',
                                ),
                                DropdownMenuItem<String>(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              ...
                              hint: const Text('Lütfen bir marka seçin'),
                              value: _brandValue,
                            ),
                          ],
                        ),
